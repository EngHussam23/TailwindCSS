...
function ArrowRightToBracket({
  ...
  return (
    ...
    >
      ...
      <path d="M10 18H7C6.448 18 6 17.551 6 17V7C6 6.449 6.448 6 7 6H10C10.553 6 11 5.552 11 5C11 4.448 10.553 4 10 4H7C5.346 4 4 5.346 4 7V17C4 18.654 5.346 20 7 20H10C10.553 20 11 19.552 11 19C11 18.448 10.553 18 10 18Z" />
    </svg>
  );
}
